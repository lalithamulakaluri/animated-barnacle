...
mongoose.connect("mongodb://localhost:27017/hkeeper");
...
function saveDoc(document) {
 DocModel.findOne( {'owner': document.owner, 'docindex':document.index },function (err, dbDocument) {
   ...
   var p = new DocModel({owner: document.owner, imageLink:document.imageLink, ipfsImageHash: document.imageLink,
   uploadTime:document.uploadTime, docstatus:document.status, insstatus:document.status
    });
...
var cmd = 'qpdf --encrypt user owner 40 --  /Users/lalitha/Downloads/Doc-Keeper-master/filezz/Doc.pdf /Users/lalitha/Downloads/Doc-Keeper-master/filezz/'+randd+'.pdf';
...
setTimeout(red, 5000);
     //IPFS
function red(){
     var file = '/Users/lalitha/Downloads/Doc-Keeper-master/filezz/'+randd+'.pdf';
